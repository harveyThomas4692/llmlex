...
def fit_curve(x, y, curve, largest_entry):
    ...
    """
    logger.info(f"Fitting curve with {largest_entry} parameters")
    ...
    try:
        ...
        logger.info(f"Optimized parameters: {params_opt}")
        ...
        logger.info(f"Error during curve fitting, getting another response: {e}", exc_info=True)
