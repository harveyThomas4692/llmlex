...
logger = logging.getLogger("LLMSR.api_tests")

if __name__ == "__main__":
    import argparse
    parser = argparse.ArgumentParser(description="Run LLMSR tests with real API calls")
    ...
    if args.max_rate:
        os.environ['LLMSR_TEST_MAX_CALLS_PER_MINUTE'] = str(args.max_rate)
